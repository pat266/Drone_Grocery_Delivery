...
Direction: Run this file first

About: Database Initialization - create different tables and types of variables
to insert later. Also insert sample data into each tables.
...
('Aidan_Test', 'password51', 'Aidan', 'Perras', 'Test Add Dr', 'Atlanta', 'GA', 30144);
...
INSERT INTO `grocery_drone_delivery`.`drone_tech` (`Username`,`StoreName`,`ChainName`) VALUES('Aidan_Test','Owl Circle',"Trader Joe's"); 
...
INSERT INTO `grocery_drone_delivery`.`drone`(`ID`,`DroneStatus`,`Zip`,`Radius`,`DroneTech`) VALUES (121,'Available',30144,7,'Aidan_Test'); 
...
/*---------ADDITIONAL INSERTS-------------------- */
INSERT INTO `grocery_drone_delivery`.`users` VALUES ('ExtraDroneOperator', 'password67', 'f', 'l', 'street', 'city', 'GA', 30047);
INSERT INTO `grocery_drone_delivery`.`employee` VALUES ('ExtraDroneOperator');
INSERT INTO `grocery_drone_delivery`.`drone_tech` VALUES ('ExtraDroneOperator', 'Pleasant Hill', 'Wal Mart');
INSERT INTO `grocery_drone_delivery`.`drone` VALUES (122, 'Busy', 30047, 11, 'ExtraDroneOperator');
INSERT INTO `grocery_drone_delivery`.`orders` VALUES (10016, 'In Transit', '2021-02-25', 'kkapoor155', 122);
INSERT INTO `grocery_drone_delivery`.`contains` VALUES (10016, 'Pepsi', 'Wal Mart', 10004, 4);
INSERT INTO `grocery_drone_delivery`.`orders` VALUES (10017, 'Pending', '2021-02-26', 'hpeterson55', null);
INSERT INTO `grocery_drone_delivery`.`contains` VALUES (10017, 'Spinach', 'Wal Mart', 10001, 4);